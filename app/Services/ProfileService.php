...
class ProfileService
{
    ...
    public function updateProfile(array $data): array
    {
        ...
        UserData::updateName((int) $profile['user_id'], $name);
    ...
    public function changePassword(array $data): array
    {
        ...
        if (! UserData::verifyPassword((int) $profile['user_id'], $currentPassword)) {
            return [
                'success' => false,
        ...
        UserData::updatePassword((int) $profile['user_id'], $newPassword);
