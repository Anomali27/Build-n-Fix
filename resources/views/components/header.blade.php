    ...
    <div class="container mx-auto px-4 lg:px-8 py-3.5 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            @auth
                ...
                <a href="{{ Route::has('cart.index') ? route('cart.index') : '#' }}" title="Keranjang" class="p-2 text-gray-300 hover:text-white hover:bg-white/10 rounded-full transition-colors relative">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                    <span class="absolute top-1 right-1 w-2 h-2 rounded-full bg-[#F97316] ring-2 ring-[#171717]"></span>
                </a>
                <!-- Profile Avatar Icon -->
